...
const Logo: React.FC<LogoProps> = ({ className = '', size = 'md' }) => {
  ...
  return (
    <div className={`${sizeClasses[size]} rounded-full overflow-hidden flex items-center justify-center bg-white shadow-md border border-slate-100 dark:border-neutral-800 ${className}`}>
      {/* 
